...
class tmp_channel(Cog_Extension):
    ...
    async def on_voice_state_update(self, member, before, after):
        with open('/Users/arcticfox/Downloads/columbina/ban.json', 'r', encoding = 'utf-8') as list:
            ...
            if int(before.channel.id) in tmp_channels_list:     #看退出去前的語音頻道是否為機器人創建的頻道
                if before.channel == None:
                    ...
                    if before.channel.members == []:
                        ...
                        with open('/Users/arcticfox/Downloads/columbina/ban.json', 'w', encoding='utf-8') as list:
